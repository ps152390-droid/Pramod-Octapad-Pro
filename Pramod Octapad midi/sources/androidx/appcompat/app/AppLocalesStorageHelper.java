...
class AppLocalesStorageHelper {
    ...
    */
    ...
    static class SerialExecutor implements Executor {
            ...
            synchronized (this.mLock) {
                this.mTasks.add(new Runnable() { // from class: androidx.appcompat.app.AppLocalesStorageHelper$SerialExecutor$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m4lambda$execute$0$androidxappcompatappAppLocalesStorageHelper$SerialExecutor(r);
                    }
                });
        ...
        /* synthetic */ void m4lambda$execute$0$androidxappcompatappAppLocalesStorageHelper$SerialExecutor(Runnable r) {
            try {
                r.run();
            } finally {
                scheduleNext();
