...
class LimitedConcurrencyExecutor implements Executor {
    ...
    private Runnable decorate(final Runnable command) {
        return new Runnable() { // from class: com.google.firebase.concurrent.LimitedConcurrencyExecutor$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m101lambda$decorate$0$comgooglefirebaseconcurrentLimitedConcurrencyExecutor(command);
            }
        };
    }
    ...
    /* synthetic */ void m101lambda$decorate$0$comgooglefirebaseconcurrentLimitedConcurrencyExecutor(Runnable command) {
        try {
            command.run();
        } finally {
            this.semaphore.release();
