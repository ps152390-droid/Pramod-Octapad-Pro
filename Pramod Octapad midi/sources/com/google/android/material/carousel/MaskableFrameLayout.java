...
public class MaskableFrameLayout extends FrameLayout implements Maskable, Shapeable {
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.maskableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.carousel.MaskableFrameLayout$$ExternalSyntheticLambda0
            ...
            public final void run(Canvas canvas2) {
                this.f$0.m45lambda$dispatchDraw$1$comgoogleandroidmaterialcarouselMaskableFrameLayout(canvas2);
            }
        });
    }
    ...
    /* synthetic */ void m45lambda$dispatchDraw$1$comgoogleandroidmaterialcarouselMaskableFrameLayout(Canvas x$0) {
