...
class SearchBarAnimationHelper {
    ...
    void startExpandAnimation(final SearchBar searchBar, final View expandedView, final AppBarLayout appBarLayout, final boolean skipAnimation) {
        ...
        expandedView.post(new Runnable() { // from class: com.google.android.material.search.SearchBarAnimationHelper$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m55lambda$startExpandAnimation$0$comgoogleandroidmaterialsearchSearchBarAnimationHelper(searchBar, expandedView, appBarLayout, skipAnimation);
            }
        });
    }
    ...
    /* synthetic */ void m55lambda$startExpandAnimation$0$comgoogleandroidmaterialsearchSearchBarAnimationHelper(SearchBar searchBar, View expandedView, AppBarLayout appBarLayout, boolean skipAnimation) {
