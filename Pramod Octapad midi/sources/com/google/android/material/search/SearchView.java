...
public class SearchView extends FrameLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    private void setUpBackButton(boolean useDrawerArrowDrawable, boolean hideNavigationIcon) {
        ...
        this.toolbar.setNavigationOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda2
            ...
            public final void onClick(View view) {
                this.f$0.m58lambda$setUpBackButton$1$comgoogleandroidmaterialsearchSearchView(view);
            }
        });
    ...
    /* synthetic */ void m58lambda$setUpBackButton$1$comgoogleandroidmaterialsearchSearchView(View v) {
        hide();
    }
    ...
    private void setUpClearButton() {
        this.clearButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m59lambda$setUpClearButton$2$comgoogleandroidmaterialsearchSearchView(view);
            }
        });
    ...
    /* synthetic */ void m59lambda$setUpClearButton$2$comgoogleandroidmaterialsearchSearchView(View v) {
        clearText();
    ...
    private void setUpContentOnTouchListener() {
        this.contentContainer.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda0
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f$0.m60lambda$setUpContentOnTouchListener$3$comgoogleandroidmaterialsearchSearchView(view, motionEvent);
            }
        });
    }
    ...
    /* synthetic */ boolean m60lambda$setUpContentOnTouchListener$3$comgoogleandroidmaterialsearchSearchView(View v, MotionEvent event) {
    ...
    private void setUpToolbarInsetListener() {
        ViewUtils.doOnApplyWindowInsets(this.toolbar, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda8
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat, ViewUtils.RelativePadding relativePadding) {
                return this.f$0.m62lambda$setUpToolbarInsetListener$4$comgoogleandroidmaterialsearchSearchView(view, windowInsetsCompat, relativePadding);
            }
        });
    }
    ...
    /* synthetic */ WindowInsetsCompat m62lambda$setUpToolbarInsetListener$4$comgoogleandroidmaterialsearchSearchView(View view, WindowInsetsCompat insets, ViewUtils.RelativePadding initialPadding) {
    ...
    private void setUpStatusBarSpacerInsetListener() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this.statusBarSpacer, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda4
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return this.f$0.m61lambda$setUpStatusBarSpacerInsetListener$5$comgoogleandroidmaterialsearchSearchView(view, windowInsetsCompat);
            }
        });
    }
    ...
    /* synthetic */ WindowInsetsCompat m61lambda$setUpStatusBarSpacerInsetListener$5$comgoogleandroidmaterialsearchSearchView(View v, WindowInsetsCompat insets) {
    ...
    public void setupWithSearchBar(SearchBar searchBar) {
        ...
        if (searchBar != null) {
            searchBar.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m63lambda$setupWithSearchBar$7$comgoogleandroidmaterialsearchSearchView(view);
                }
            });
        }
    ...
    /* synthetic */ void m63lambda$setupWithSearchBar$7$comgoogleandroidmaterialsearchSearchView(View v) {
        show();
    }
    ...
    public void requestFocusAndShowKeyboard() {
        this.editText.postDelayed(new Runnable() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda5
            ...
            public final void run() {
                this.f$0.m57lambda$requestFocusAndShowKeyboard$8$comgoogleandroidmaterialsearchSearchView();
            }
    ...
    /* synthetic */ void m57lambda$requestFocusAndShowKeyboard$8$comgoogleandroidmaterialsearchSearchView() {
    ...
    public void clearFocusAndHideKeyboard() {
        this.editText.post(new Runnable() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m56lambda$clearFocusAndHideKeyboard$9$comgoogleandroidmaterialsearchSearchView();
            }
        });
    }
    ...
    /* synthetic */ void m56lambda$clearFocusAndHideKeyboard$9$comgoogleandroidmaterialsearchSearchView() {
