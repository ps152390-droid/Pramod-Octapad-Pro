...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout(this.viewRef.get(), new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m69lambda$setState$0$comgoogleandroidmaterialsidesheetSideSheetBehavior(state);
                }
            });
        }
    }
    ...
    /* synthetic */ void m69lambda$setState$0$comgoogleandroidmaterialsidesheetSideSheetBehavior(int finalState) {
    ...
    class StateSettlingTracker {
        private final Runnable continueSettlingRunnable = new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$StateSettlingTracker$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m70lambda$new$0$comgoogleandroidmaterialsidesheetSideSheetBehavior$StateSettlingTracker();
            }
        };
        ...
        /* synthetic */ void m70lambda$new$0$comgoogleandroidmaterialsidesheetSideSheetBehavior$StateSettlingTracker() {
    ...
    private AccessibilityViewCommand createAccessibilityViewCommandForState(final int state) {
        return new AccessibilityViewCommand() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda1
            ...
            public final boolean perform(View view, AccessibilityViewCommand.CommandArguments commandArguments) {
                return this.f$0.m68lambda$createAccessibilityViewCommandForState$1$comgoogleandroidmaterialsidesheetSideSheetBehavior(state, view, commandArguments);
            }
        };
    }
    ...
    /* synthetic */ boolean m68lambda$createAccessibilityViewCommandForState$1$comgoogleandroidmaterialsidesheetSideSheetBehavior(int state, View view, AccessibilityViewCommand.CommandArguments arguments) {
        setState(state);
        return true;
    }
}
