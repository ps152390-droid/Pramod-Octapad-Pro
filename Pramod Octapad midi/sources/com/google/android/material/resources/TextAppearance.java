    ...
    public void getFontAsync(Context context, final TextAppearanceFontCallback callback) {
        ...
        try {
            ResourcesCompat.getFont(context, i, new ResourcesCompat.FontCallback() { // from class: com.google.android.material.resources.TextAppearance.1
                ...
                public void m12lambda$callbackSuccessAsync$0$androidxcorecontentresResourcesCompat$FontCallback(Typeface typeface) {
                ...
                public void m11lambda$callbackFailAsync$1$androidxcorecontentresResourcesCompat$FontCallback(int reason) {
                    TextAppearance.this.fontResolved = true;
