...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    /* synthetic */ void m79lambda$new$0$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(View view) {
        showHideDropdown();
    }
    ...
    /* synthetic */ void m80lambda$new$1$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(View view, boolean hasFocus) {
    ...
    /* synthetic */ void m81lambda$new$2$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(boolean enabled) {
    ...
    DropdownMenuEndIconDelegate(EndCompoundLayout endLayout) {
        ...
        this.onIconClickListener = new View.OnClickListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                this.f$0.m79lambda$new$0$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(view);
            }
        };
        this.onEditTextFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda1
            ...
            public final void onFocusChange(View view, boolean z) {
                this.f$0.m80lambda$new$1$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(view, z);
            }
        };
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda2
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m81lambda$new$2$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(z);
            }
        };
    ...
    public void afterEditTextChanged(Editable s) {
        ...
        this.autoCompleteTextView.post(new Runnable() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda4
            ...
            public final void run() {
                this.f$0.m77lambda$afterEditTextChanged$3$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate();
            }
        });
    }
    ...
    /* synthetic */ void m77lambda$afterEditTextChanged$3$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate() {
    ...
    private void setUpDropdownShowHideBehavior() {
        this.autoCompleteTextView.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda5
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f$0.m82lambda$setUpDropdownShowHideBehavior$4$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(view, motionEvent);
            }
        });
        if (IS_LOLLIPOP) {
            this.autoCompleteTextView.setOnDismissListener(new AutoCompleteTextView.OnDismissListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda6
                ...
                public final void onDismiss() {
                    this.f$0.m83lambda$setUpDropdownShowHideBehavior$5$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate();
                }
            });
        }
    ...
    /* synthetic */ boolean m82lambda$setUpDropdownShowHideBehavior$4$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(View view, MotionEvent event) {
    ...
    /* synthetic */ void m83lambda$setUpDropdownShowHideBehavior$5$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate() {
        updateDropdownPopupDirty();
        setEndIconChecked(false);
    }
    ...
    private ValueAnimator getAlphaAnimator(int duration, float... values) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda3
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m78lambda$getAlphaAnimator$6$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(valueAnimator);
            }
        });
        return animator;
    }
    ...
    /* synthetic */ void m78lambda$getAlphaAnimator$6$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(ValueAnimator animation) {
