...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    /* synthetic */ void m74lambda$new$0$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(View view) {
    ...
    /* synthetic */ void m75lambda$new$1$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(View view, boolean hasFocus) {
    ...
    ClearTextEndIconDelegate(EndCompoundLayout endLayout) {
        ...
        this.onIconClickListener = new View.OnClickListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda3
            ...
            public final void onClick(View view) {
                this.f$0.m74lambda$new$0$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(view);
            }
        };
        this.onFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda4
            ...
            public final void onFocusChange(View view, boolean z) {
                this.f$0.m75lambda$new$1$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(view, z);
            }
        };
        ...
        if (editText != null) {
            editText.post(new Runnable() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m76lambda$tearDown$2$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate();
                }
            });
        }
    }
    ...
    /* synthetic */ void m76lambda$tearDown$2$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate() {
        animateIcon(true);
    }
    ...
    private ValueAnimator getAlphaAnimator(float... values) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m72lambda$getAlphaAnimator$3$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(valueAnimator);
            }
        });
        return animator;
    }
    ...
    /* synthetic */ void m72lambda$getAlphaAnimator$3$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(ValueAnimator animation) {
    ...
    private ValueAnimator getScaleAnimator() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m73lambda$getScaleAnimator$4$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(valueAnimator);
            }
        });
        return animator;
    }
    ...
    /* synthetic */ void m73lambda$getScaleAnimator$4$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(ValueAnimator animation) {
