    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                objM130constructorimpl = Result.m130constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.INSTANCE;
            objM130constructorimpl = Result.m130constructorimpl(outcome);
            Object outcome2 = objM130constructorimpl;
