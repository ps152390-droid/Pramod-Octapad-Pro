...
public final class UnsignedKt {
    ...
    public static final int m477uintDivideJ1ME1BU(int v1, int v2) {
    ...
    public static final int m478uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m224constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m479ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m302constructorimpl(ulongCompare(v1, v2) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m302constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        return ULong.m302constructorimpl(((long) (ulongCompare(ULong.m302constructorimpl(rem), ULong.m302constructorimpl(v2)) < 0 ? 0 : 1)) + quotient);
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m480ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (ulongCompare(ULong.m302constructorimpl(rem), ULong.m302constructorimpl(v2)) >= 0) {
            j = v2;
        }
        return ULong.m302constructorimpl(rem - j);
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        return v < 9.223372036854776E18d ? ULong.m302constructorimpl((long) v) : ULong.m302constructorimpl(ULong.m302constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
