...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1619receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1619receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1620tryReceivePtdJZtk() {
        return this._channel.mo1620tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo1621trySendJP2dKIU(E element) {
        return this._channel.mo1621trySendJP2dKIU(element);
    }
