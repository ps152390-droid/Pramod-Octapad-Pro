...
public interface SendChannel<E> {
    ...
    Object mo1621trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1621trySendJP2dKIU(e);
            if (ChannelResult.m1636isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1630exceptionOrNullimpl = ChannelResult.m1630exceptionOrNullimpl(result);
