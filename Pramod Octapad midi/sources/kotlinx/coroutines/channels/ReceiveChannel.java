...
public interface ReceiveChannel<E> {
    ...
    Object mo1619receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1620tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1620tryReceivePtdJZtk = receiveChannel.mo1620tryReceivePtdJZtk();
            if (ChannelResult.m1636isSuccessimpl(objMo1620tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1632getOrThrowimpl(objMo1620tryReceivePtdJZtk);
            }
            Throwable thM1630exceptionOrNullimpl = ChannelResult.m1630exceptionOrNullimpl(objMo1620tryReceivePtdJZtk);
            if (thM1630exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1630exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) throws java.lang.Throwable {
            ...
            L38:
                ...
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo1619receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1631getOrNullimpl(r3)
                return r3
            */
